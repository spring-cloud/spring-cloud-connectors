= Spring Cloud Connectors image:https://build.spring.io/plugins/servlet/wittified/build-status/CLOUD-CONNECTORS2[Build status]
...
See the https://spring.io/projects/spring-cloud-connectors/[project site] and http://cloud.spring.io/spring-cloud-connectors/spring-cloud-connectors.html[current documentation].
